...
class Axis_1(object):
    ...
    def unit(self) -> str:
        ...
        value = self._quam._json[self._path + "unit"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def unit(self, value: str):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "unit")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "unit"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "unit"] = value

    @property
    def values(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        ...
        value = self._quam._json[self._path + "values"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @values.setter
    def values(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "values")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "values"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "values"] = value
...
class Scan_parameters(object):
    ...
    @property
    def axis_1(self) -> Axis_1:
        """"""
        return Axis_1(
            self._quam, self._path + "axis_1/", self._index,
            self._schema["properties"]["axis_1"]
        )

    @property
    def axis_2(self) -> Axis_2:
        """"""
        return Axis_2(
            self._quam, self._path + "axis_2/", self._index,
            self._schema["properties"]["axis_2"]
        )

    @property
    def axis_3(self) -> Axis_3:
        """"""
        return Axis_3(
            self._quam, self._path + "axis_3/", self._index,
            self._schema["properties"]["axis_3"]
        )

    @property
    def axis_4(self) -> Axis_4:
        """"""
        return Axis_4(
            self._quam, self._path + "axis_4/", self._index,
            self._schema["properties"]["axis_4"]
        )
...
class OthersList(object):
    ...
    def __getitem__(self, key) -> Other:
        return Other(
            self._quam,
            self._path + "[]/",
            self._index + [key],
    ...
    def append(self, json_item:dict):
        """Adds a new other by adding a JSON dictionary with following schema
{
  "name": {
    "type": "string"
  },
...
class Data(object):
    ...
    def n_avg(self) -> int:
        ...
        value = self._quam._json[self._path + "n_avg"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @n_avg.setter
    def n_avg(self, value: int):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "n_avg")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "n_avg"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "n_avg"] = value
    ...
    @property
    def others(self) -> OthersList:
        """"""
        return OthersList(
            self._quam, self._path + "others", self._index,
            self._schema["properties"]["others"]
        )
    ...
    def scan_parameters(self) -> Scan_parameters:
        ...
        return Scan_parameters(
            self._quam, self._path + "scan_parameters/", self._index,
            self._schema["properties"]["scan_parameters"]
        )
...
class DataList(object):
    ...
    def append(self, json_item:dict):
        """Adds a new data by adding a JSON dictionary with following schema
{
  "qubit_index": {
    "type": "integer"
  },
...
class Results(object):
    ...
    @property
    def qua_program(self) -> str:
        """"""
        
        value = self._quam._json[self._path + "qua_program"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @qua_program.setter
    def qua_program(self, value: str):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "qua_program")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "qua_program"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "qua_program"] = value

    @property
    def data(self) -> DataList:
        """"""
        return DataList(
            self._quam, self._path + "data", self._index,
            self._schema["properties"]["data"]
        )
...
class QuAM(object):
    ...
    def save_results(self, filename, figures: List = (), data={}, qua_program=''):
        """"""
        with _add_path(os.path.dirname(os.path.abspath(__file__))):
            import config
        return config.save_results(self, filename, figures, data, qua_program)
