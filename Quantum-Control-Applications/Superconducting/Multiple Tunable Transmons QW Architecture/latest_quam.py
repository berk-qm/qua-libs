...
if simulate:
    ...
    data = [{"qubit_index": q,
             ...
             "others": [{
                 "name": "amplitude",
                 "unit": "a.u.",
                 "values": np.sqrt(qubit_data[q]["I"]**2 + qubit_data[q]["Q"]**2)
             }],
             }
            for q in qubit_list]


    machine.save_results(experiment, figures, data=data, qua_program=os.path.basename(__file__))
